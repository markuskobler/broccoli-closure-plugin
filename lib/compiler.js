...
//Compiler.OPTIONS   = {}
Compiler.JAR_PATH  = path.join(__dirname, '..', 'vendor', 'compiler.jar')
Compiler.JAVA_PATH = _javaPath()

// TODO
// - Check/Download latest jar version
// - Externs support
// - Configure java args
...
function _compile(cwd, files, destFile, options, debug) {
  var java = _take(options, 'java')
  var args = ['-server', '-XX:+TieredCompilation'] // TODO configure java args?
